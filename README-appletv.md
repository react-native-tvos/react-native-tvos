...
Releases of `react-native-tvos` will be based on a public release of `react-native`; e.g. the 0.60.4-4 release of this package will be derived from the 0.60.4 release of `react-native`.
...
```js
"react-native": "npm:react-native-tvos@0.60.4-4",
```
...
```sh
react-native init TestApp --version=react-native@npm:react-native-tvos@0.60.4-4
