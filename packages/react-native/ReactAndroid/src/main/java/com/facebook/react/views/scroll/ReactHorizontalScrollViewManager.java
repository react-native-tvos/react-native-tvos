...
public class ReactHorizontalScrollViewManager extends ViewGroupManager<ReactHorizontalScrollView>
  ...
  public void scrollTo(final ReactHorizontalScrollView scrollView, final ReactScrollViewCommandHelper.ScrollToCommandData data ) {
    ...
    if (isRTL && scrollView.getChildAt(0) instanceof ReactHorizontalScrollContainerLegacyView) {
      final ReactHorizontalScrollContainerLegacyView child = (ReactHorizontalScrollContainerLegacyView) scrollView.getChildAt(0);
      ...
      child.setListener(new ReactHorizontalScrollContainerLegacyView.Listener() {
        @Override
