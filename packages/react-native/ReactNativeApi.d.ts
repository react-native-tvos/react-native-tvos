 ...
 *
 * @generated SignedSource<<32db38ee1cdaab0a6a52ab2d53eeeef5>>
 *
        ...
        Readonly<
          MaximumOneOf<
            MergeUnion<
              ...
              | {
                  perspective: AnimatedNode_default | number
                }
              | {
                  rotate: AnimatedNode_default | string
                }
              | {
                  rotateX: AnimatedNode_default | string
                }
              | {
                  rotateY: AnimatedNode_default | string
                }
              | {
                  rotateZ: AnimatedNode_default | string
                }
              | {
                  scale: AnimatedNode_default | number
                }
              | {
                  scaleX: AnimatedNode_default | number
                }
              | {
                  scaleY: AnimatedNode_default | number
                }
              | {
                  skewX: AnimatedNode_default | string
                }
              | {
                  skewY: AnimatedNode_default | string
                }
              | {
                  translate:
                    | [
              ...
              | {
                  translateX: AnimatedNode_default | number | string
                }
              | {
                  translateY: AnimatedNode_default | number | string
                }
            >
          >
        >
...
declare class AnimatedValueXY_default extends AnimatedWithChildren_default {
  ...
  constructor(
    valueIn?:
      ...
      | undefined
      | {
          x: AnimatedValue_default | number
          y: AnimatedValue_default | number
        },
...
declare interface NativeMouseEvent extends NativeUIEvent {
  ...
  pageX: number
  pageY: number
  relatedTarget: HostInstance | null | number
  screenX: number
  screenY: number
  shiftKey: boolean
  x: number
...
declare interface ScrollViewImperativeMethods {
  flashScrollIndicators: () => void
  getInnerViewNode: () => number | undefined
  getInnerViewRef: () => InnerViewInstance | null
  getNativeScrollRef: () => null | ScrollViewInstance
  ...
  scrollToEnd: (options?: ScrollViewScrollToOptions | undefined) => void
}
...
declare interface Spec extends TurboModule {
  ...
  getConstantsForViewManager?: (viewManagerName: string) => Object | undefined
  ...
  measure: (reactTag: number, callback: NativeMeasureOnSuccessCallback) => void
  measureInWindow: (
    reactTag: number,
...
export {
  AccessibilityActionEvent, // cbae6b74
  AccessibilityActionInfo, // db47a917
  AccessibilityInfo, // 997e2685
  ...
  ActivityIndicator, // f8e1aae9
  ActivityIndicatorInstance, // 1a26a7e6
  ActivityIndicatorProps, // 175cae0c
  Alert, // a398a509
  ...
  BackHandler, // 512fa446
  BackPressEventName, // 4620fb76
  BlurEvent, // 47ba0cbf
  BoxShadowValue, // b679703f
  Button, // 52345f0a
  ButtonInstance, // e51dee8e
  ButtonProps, // 79de7e8b
  Clipboard, // 41addb89
  CodegenTypes, // cdaa9939
  ...
  FlatList, // 6d7e4e2c
  FlatListInstance, // 284c89bc
  FlatListProps, // c9ae15de
  FocusEvent, // b9c67d29
  FontVariant, // 7c7558bb
  GestureResponderEvent, // 86ba82ac
  GestureResponderHandlers, // afdabc26
  HostComponent, // 7f0694a3
  HostInstance, // 7fb82fc0
  I18nManager, // f9870e00
  IEventEmitter, // fbef6131
  IOSKeyboardEvent, // e67bfe3a
  IgnorePattern, // ec6f6ece
  Image, // 04eff887
  ImageBackground, // c5180dad
  ImageBackgroundInstance, // 9fabfcb9
  ImageBackgroundProps, // 8ce54364
  ImageErrorEvent, // a3cf35e7
  ImageInstance, // c5a1cdeb
  ImageLoadEvent, // 66e0b8eb
  ImageProgressEventIOS, // 21407b9c
  ImageProps, // a1a431df
  ImagePropsAndroid, // a95da84b
  ImagePropsBase, // 827658cb
  ImagePropsIOS, // 4c6fc610
  ImageRequireSource, // 681d683b
  ImageResizeMode, // d51106e2
  ImageResolvedAssetSource, // 50193d00
  ImageSize, // 1c47cf88
  ImageSource, // 2ce31f58
  ImageSourcePropType, // 0ccdac2f
  ImageStyle, // 238d85b4
  ImageURISource, // 1471f636
  InputAccessoryView, // 46f88434
  InputAccessoryViewProps, // e29b8a7c
  InputModeOptions, // 4e8581b9
  Insets, // e7fe432a
  KeyDownEvent, // a821175c
  KeyEvent, // 20fa4267
  KeyUpEvent, // b925ced3
  Keyboard, // 49414c97
  KeyboardAvoidingView, // ae27c0fe
  KeyboardAvoidingViewInstance, // 751ffaee
  KeyboardAvoidingViewProps, // 8468621e
  ...
  Modal, // 08f712c4
  ModalBaseProps, // 978fd82f
  ModalInstance, // 0423c7ca
  ModalProps, // bd47c376
  ModalPropsAndroid, // 515fb173
  ModalPropsIOS, // 9f5b2c5d
  ModeChangeEvent, // 88bb0382
  MouseEvent, // 45d0adf1
  NativeAppEventEmitter, // 08d4c47d
  NativeColorValue, // d2094c29
  NativeComponentRegistry, // 275a4f4d
  NativeEventEmitter, // 27f97c1a
  NativeEventSubscription, // de3942e7
  NativeModules, // 4597cd36
  NativeMouseEvent, // 0b6dd968
  NativePointerEvent, // 6bdc4339
  NativeScrollEvent, // caad7f53
  NativeSyntheticEvent, // d6f52483
  NativeTouchEvent, // 59b676df
  NativeUIEvent, // e9ffaa05
  Networking, // bbc5be42
  OpaqueColorValue, // 25f3fa5b
  PackagerAsset, // d1c88cf4
  PanResponder, // c49edeed
  PanResponderCallbacks, // 8aeddc29
  PanResponderGestureState, // 54baf558
  PanResponderInstance, // e0cd90c0
  Permission, // 08f1c82f
  ...
  PointValue, // 69db075f
  PointerEvent, // e0937be6
  PressabilityConfig, // f8f89521
  PressabilityEventHandlers, // 250a9f66
  Pressable, // 2fbe4a9d
  PressableAndroidRippleConfig, // ee32eaca
  PressableInstance, // 7c0b2b70
  PressableProps, // 885732f4
  PressableStateCallbackType, // 9af36561
  ProcessedColorValue, // 33f74304
  ProgressBarAndroid, // 0721a4dc
  ProgressBarAndroidInstance, // 1145a399
  ProgressBarAndroidProps, // 5101b11b
  PublicRootInstance, // 8040afd7
  PublicTextInstance, // c8f6f57a
  ...
  RefreshControl, // 7b0ec443
  RefreshControlInstance, // aba9d68d
  RefreshControlProps, // ed4f2444
  RefreshControlPropsAndroid, // 8ac931ca
  RefreshControlPropsIOS, // 72a36381
  Registry, // 6c39216d
  ResponderSyntheticEvent, // 98dfdb20
  ReturnKeyTypeOptions, // afd47ba3
  Role, // af7b889d
  RootTag, // 3cd10504
  RootTagContext, // 38bfc8f6
  RootViewStyleProvider, // 1d516ac0
  Runnable, // 594dd93a
  Runnables, // 4367c557
  SafeAreaView, // a6df344f
  SafeAreaViewInstance, // f4075a1f
  ScaledSize, // 07e417c7
  ScrollEvent, // 2920c3c4
  ScrollResponderType, // 867a36b6
  ScrollToLocationParamsType, // d7ecdad1
  ScrollView, // 87761908
  ScrollViewImperativeMethods, // 6d70d32d
  ScrollViewInstance, // 8b20e333
  ScrollViewProps, // 20c50c4c
  ScrollViewPropsAndroid, // 02f3df2e
  ScrollViewPropsIOS, // 73e5e0c7
  ScrollViewScrollToOptions, // 3313411e
  SectionBase, // 9f13db00
  SectionList, // 02323a93
  SectionListData, // 1a4de01a
  SectionListInstance, // 8769de0a
  SectionListProps, // 02a3282c
  ...
  Switch, // d8cb94ad
  SwitchChangeEvent, // deb8af9e
  SwitchInstance, // c73a03c0
  SwitchProps, // f9221a05
  Systrace, // 626d178c
  ...
  TextInputBlurEvent, // 01b62234
  TextInputChangeEvent, // b1931d55
  TextInputContentSizeChangeEvent, // 96a062f1
  TextInputEndEditingEvent, // 562d90c4
  TextInputFocusEvent, // 2db1ab73
  TextInputIOSProps, // fb3c9327
  TextInputInstance, // f6f542e3
  TextInputKeyPressEvent, // 563ee3d6
  TextInputProps, // c61f6c0d
  TextInputSelectionChangeEvent, // 20d0d32f
  TextInputSubmitEditingEvent, // 6d47e34c
  TextInstance, // b15bac3c
  TextLayoutEvent, // 39b79eae
  TextProps, // 361e211b
  TextStyle, // 92bf2975
  ToastAndroid, // 88a8969a
  TouchableHighlight, // 158fd488
  TouchableHighlightInstance, // 0fe561fb
  TouchableHighlightProps, // 498d20ea
  TouchableNativeFeedback, // 4b9ec4b1
  TouchableNativeFeedbackInstance, // 26989238
  TouchableNativeFeedbackProps, // 690c183a
  TouchableOpacity, // 73c42eb1
  TouchableOpacityInstance, // 53d94056
  TouchableOpacityProps, // 2dc61514
  TouchableWithoutFeedback, // 8677eb27
  TouchableWithoutFeedbackProps, // d31c22c1
  TransformsStyle, // 9f6b4044
  TurboModule, // c203096b
  TurboModuleRegistry, // 3256c9db
  UIManager, // 4e842d75
  UTFSequence, // ad625158
  Vibration, // 31e4bbf8
  View, // d425ee9b
  ViewInstance, // 80f14937
  ViewProps, // 9a58e6a8
  ViewPropsAndroid, // 66c00baf
  ViewPropsIOS, // 58ee19bf
  ViewStyle, // 97cd3af1
  VirtualViewMode, // 6be59722
  VirtualizedList, // 68c7345e
  VirtualizedListInstance, // 423ee7c0
  VirtualizedListProps, // d716acf9
  VirtualizedSectionList, // 9fd9cd61
  VirtualizedSectionListInstance, // 12b706d5
  VirtualizedSectionListProps, // a1a2fae3
  WrapperComponentProvider, // 9ef54e61
  codegenNativeCommands, // 628a7c0a
  codegenNativeComponent, // 2b12679f
  findNodeHandle, // 93f80214
  processColor, // 6e877698
  registerCallableModule, // 839c8cfe
  requireNativeComponent, // 2aef3103
  useAnimatedColor, // 1a2f35ca
  useAnimatedValue, // 3eb9d3c0
  useAnimatedValueXY, // 5abb5eae
  useColorScheme, // d585efdb
  usePressability, // 81db6214
